#!/bin/bash
#SBATCH --job-name=xlmr-jv
#SBATCH --output=xlmr_jv.out
#SBATCH --nodes=1
...
# python /home/shailyjb/anlp-figlang/src/Trainer.py --output-dir="/data/tir/projects/tir5/users/shailyjb/anlp-figlang/hi_50_re" --train-file "/home/shailyjb/anlp-figlang/data/few_shot/train_merged/hi/hi_50.csv" --val-file "/home/shailyjb/anlp-figlang/data/validation/en.csv"
# python /home/shailyjb/anlp-figlang/src/Trainer.py --output-dir="/data/tir/projects/tir5/users/shailyjb/anlp-figlang/id_50_re" --train-file "/home/shailyjb/anlp-figlang/data/few_shot/train_merged/id/id_50.csv" --val-file "/home/shailyjb/anlp-figlang/data/validation/en.csv"
python /home/shailyjb/anlp-figlang/src/Trainer.py --output-dir="/data/tir/projects/tir5/users/shailyjb/anlp-figlang/jv_50_re" --train-file "/home/shailyjb/anlp-figlang/data/few_shot/train_merged/jv/jv_50.csv" --val-file "/home/shailyjb/anlp-figlang/data/validation/en.csv"
